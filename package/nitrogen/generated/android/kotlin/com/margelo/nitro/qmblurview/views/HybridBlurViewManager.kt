...
/**
 * Represents the React Native `ViewManager` for the "BlurView" Nitro HybridView.
 */
open class HybridBlurViewManager: SimpleViewManager<View>() {
  init {
    if (RecyclableView::class.java.isAssignableFrom(HybridBlurView::class.java)) {
  ...
  override fun createViewInstance(reactContext: ThemedReactContext): View {
    val hybridView = HybridBlurView(reactContext)
  ...
  override fun updateState(view: View, props: ReactStylesDiffMap, stateWrapper: StateWrapper): Any? {
    val hybridView = view.getTag(associated_hybrid_view_tag) as? HybridBlurView
      ?: throw Error("Couldn't find view $view in local views table!")

    // 1. Update each prop individually
    hybridView.beforeUpdate()
    HybridBlurViewStateUpdater.updateViewProps(hybridView, stateWrapper)
